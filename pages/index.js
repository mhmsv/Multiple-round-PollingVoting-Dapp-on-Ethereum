...
export const home = () => {
    ...
    const votingContractFunction = web3 => {
        return new web3.eth.Contract(abi, "0xfaAAa136bCad981885ef751aB1bF3866e6a016e9")
    }
    ...
    const startUpdatingProposalHandler = async () => {
        ...
        try {
            ...
            if (state_tmp == 7) {
                ...
                setError("");
                setSuccessMsg("State Successfully changed to Updating Proposals")
    ...
    return (
        <div >
            ...
            <nav className="navbar" role="navigation" aria-label="main navigation mt-9 mb-5">
